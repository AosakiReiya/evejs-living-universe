...
function spawnNativeNpcGroupInSystem(systemID, options = {}) {
  ...
  const groupResult = resolveNpcSpawnGroupPlan(
    ...
    {
      entityType: String(options.entityType || ENTITY_TYPE.NPC),
